...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    sum=abs((opponent_score//10)%10-player_score%10)
    if sum==0:
        return 1
    return 3*sum
    # END PROBLEM 2
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    myscore = boar_brawl(score,opponent_score)
    myscore = sus_points(myscore+score)
    if myscore-score>=threshold:
        return 0
